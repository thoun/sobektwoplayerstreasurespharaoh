...
<div id="sbk-modal">
	<div id="player-aid-character-wrapper">
		...
		<div id="player-aid-character-pharaoh">
			<div class="pa pa-royal-adviser">
				<h2 class="sbk-to-localise" data-text="Royal Adviser"></h2>
				<p class="sbk-to-localise" data-text="Discard 1 Royal corruption token of your choice among the ones you have."></p>
			</div>
			<div class="pa pa-spy">
				<h2 class="sbk-to-localise" data-text="Spy"></h2>
				<p class="sbk-to-localise" data-text="Apply the ability of a Character tile of your choice, among the ones that have already been used for their ability during this game. So, you can not choose the ability of a character that has been sold within a set of goods."></p>
			</div>
		</div>
	</div>
	<div id="player-aid-pirogue-wrapper">
		...
		<div id="player-aid-pirogue-pharaoh">
			<div class="pa pa-discard-deben">
				<p class="sbk-to-localise" data-text="Your opponent must randomly discard 1 Deben token among the ones they have."></p>
			</div>
			<div class="pa pa-scarabs-pharaoh">
				<p class="sbk-to-localise" data-text="Place this token on one of your previously sold sets corresponding to one of the 2 types shown. It adds 2 Scarabs to this set at the end of the game during final score calculation. You may add this token to the set that you just sold this turn if it matches."></p>
			</div>
		</div>
	</div>
